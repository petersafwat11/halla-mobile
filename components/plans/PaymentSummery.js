      ...
      >
        ...
        <View style={styles.section}>
          ...
          <View style={styles.planSummaryCard}>
            ...
            <View style={styles.planDetail}>
              <Text style={[styles.planDetailText, isRTL && styles.textRTL]}>
                50 ضيف
              </Text>
            </View>
          </View>
          ...
          {additionalFeatures.length > 0 && (
            <View style={styles.additionalFeaturesCard}>
              <View style={[styles.additionalHeader, isRTL && styles.additionalHeaderRTL]}>
                ...
                <Text style={[styles.additionalTitle, isRTL && styles.textRTL]}>
                  الخدمات الإضافية
                </Text>
              </View>
        ...
        <View style={styles.section}>
          ...
          <View style={[styles.discountInputContainer, isRTL && styles.discountInputContainerRTL]}>
            ...
            <TextInput
              style={[styles.discountInput, isRTL && styles.discountInputRTL]}
