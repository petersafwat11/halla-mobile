            ...
            <View style={styles.chatBubble}>
              ...
              {templateImage ? (
                ...
                <View style={styles.placeholderImage}>
                  <Ionicons name="image-outline" size={48} color="#C28E5C" />
                  <Text style={styles.placeholderText}>صورة القالب</Text>
                </View>
              )}
              ...
              <View style={styles.eventDetails}>
                ...
                {displayTitle && (
                  <Text
                    style={[styles.eventTitle, isRTL && styles.eventTitleRTL]}
                  >
                    {displayTitle}
                  </Text>
                )}
                ...
                {invitationMessage && (
                  <Text
                    style={[
                      ...
                      isRTL && styles.invitationMessageRTL,
                    ]}
                  >
                    {invitationMessage}
                  </Text>
                ...
                {formattedDate && (
                  <View
                    style={[styles.detailRow, isRTL && styles.detailRowRTL]}
                  >
                    <Ionicons
                    ...
                    />
                    <Text
                      style={[styles.detailText, isRTL && styles.detailTextRTL]}
                    >
